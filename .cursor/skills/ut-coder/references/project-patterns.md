...
> **Sync:** This file is replicated across `ut-analyst/references/`, `ut-architect/references/`, and `ut-coder/references/`. The canonical source is `.github/skills/ut-analyst/references/project-patterns.md`. Update all three skill folders (and their `.cursor/skills/` mirrors) together when changing project conventions.
