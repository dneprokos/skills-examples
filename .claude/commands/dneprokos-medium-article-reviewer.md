...
Review the Medium article at: $ARGUMENTS
...
Read the file at `.claude/commands/references/writing-style-guide.md` in full. This is your scoring rubric — keep it in mind throughout the entire analysis.
...
2. Compare it against the relevant categories in the style guide
