...
> **Sync:** This file is replicated in `ut-analyst/references/` and `ut-coder/references/`. **This copy is the canonical source.** Update both (and their `.cursor/skills/` mirrors) together.
